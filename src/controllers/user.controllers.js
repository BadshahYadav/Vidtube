...
const registerUser = asyncHandler( async(req, res)=>{
    ...
    if(existedUser){
        throw new ApiError(409, "User with this email or this username already existed")
    }
    ...
    .json(new ApiResponse(200, createdUser, "User registered successfully"));
        ...
        throw new ApiError(500, "Something went wrong while registering a user and image were deleted from cloudinary")
    }
